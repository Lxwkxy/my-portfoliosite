...
function InfoOne() {
  return (
    ...
    <div className='container mx-auto flex item-center py-16 flex flex-col md:flex-row'>
      <div className="md:w-3/4 lg:w-1/2 justify-items-center">
      ...
      <div className="md:w-3/4 lg:w-1/2 px-6 justify-items-center">
          <div className='bg-blue-500 text-white px-6 py-2 rounded-full mt-8 inline-block font-thaiFont justify-self-center'>
            ประวัติส่วนตัว
          </div>
